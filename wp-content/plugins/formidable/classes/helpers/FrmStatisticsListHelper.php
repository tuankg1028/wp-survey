...
class FrmStatisticsListHelper extends FrmListHelper {
	public $status = '';
...
<?php
	...
	private function get_actions( &$actions, $item, $edit_link ) {
		...
		if ( current_user_can( 'frm_edit_forms' ) ) {
            $actions['frm_statistic'] = '<a href="' . esc_url( '?page=statistics&frm_action=statistic&id=' . $item->id ) . '">' . __( 'Statistic', 'formidable' ) . '</a>';
